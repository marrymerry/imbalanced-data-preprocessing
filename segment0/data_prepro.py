...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\segment0')
...
#print (data)
#从去掉表头的txt文件读取数据
data=pd.read_table('segment0.txt',names=['Region-centroid-col','Region-centroid-row','Region-pixel-count','Short-line-density-5','Short-line-density-2','Vedge-mean','Vegde-sd','Hedge-mean','Hedge-sd',
'Intensity-mean','Rawred-mean','Rawblue-mean','Rawgreen-mean','Exred-mean','Exblue-mean','Exgreen-mean','Value-mean','Saturatoin-mean','Hue-mean','class'],sep=', ')
#print(data)
...
data_new1.to_csv('segment0_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('segment0_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('segment0_new3.arff',sep=',',header=False,index=False)
