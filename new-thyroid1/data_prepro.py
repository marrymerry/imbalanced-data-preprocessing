...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\new-thyroid1')
...
#print (data)
#从去掉表头的txt文件读取数据
data=pd.read_table('new-thyroid1.txt',names=['T3resin','Thyroxin','Triiodothyronine','Thyroidstimulating','TSH_valu','class'],sep=', ')
#print(data)
...
data_new1.to_csv('new-thyroid1_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('new-thyroid1_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('new-thyroid1_new3.arff',sep=',',header=False,index=False)
