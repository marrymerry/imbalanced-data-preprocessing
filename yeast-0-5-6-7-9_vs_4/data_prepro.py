...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\yeast-0-5-6-7-9_vs_4')
import pandas as pd
import numpy as np
...
#print (data)
#从去掉表头的txt文件读取数据
data=pd.read_table('yeast_0.txt',names=['Mcg','Gvh','Alm','Mit','Erl','Pox','Vac','Nuc','class'],sep=',')
#print(data)
...
data_new1.to_csv('yeast_0_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('yeast_0_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('yeast_0_new3.arff',sep=',',header=False,index=False)
