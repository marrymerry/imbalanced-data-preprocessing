...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\yeast6')
import pandas as pd
import numpy as np
...
data_new1.to_csv('yeast6_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('yeast6_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('yeast6_new3.arff',sep=',',header=False,index=False)
