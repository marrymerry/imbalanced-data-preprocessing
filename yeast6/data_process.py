# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 15:22:37 2017
...
data_new1.to_csv('yeast6_new1.csv',sep=',',header=False,index=False)
data_new2.to_csv('yeast6_new2.csv',sep=',',header=False,index=False)
data_new3.to_csv('yeast6_new3.csv',sep=',',header=False,index=False)
"""
