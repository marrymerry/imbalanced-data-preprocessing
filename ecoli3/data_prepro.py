...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\ecoli3')
...
#print (data)
#从去掉表头的txt文件读取数据
data=pd.read_table('ecoli3.txt',names=['Mcg','Gvh','Lip','Chg','Aac','Alm1','Alm2','class'],sep=', ')
#print(data)
...
data_new1.to_csv('ecoli3_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('ecoli3_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('ecoli3_new3.arff',sep=',',header=False,index=False)
