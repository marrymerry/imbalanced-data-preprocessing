...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\glass4')
...
#print (data)
#从去掉表头的txt文件读取数据
data=pd.read_table('glass4.txt',names=['RI','Na','Mg','Al','Si','K','Ca','Ba','Fe','class'],sep=', ')
#print(data)
...
data_new1.to_csv('glass4_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('glass4_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('glass4_new3.arff',sep=',',header=False,index=False)
