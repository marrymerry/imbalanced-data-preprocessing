...
os.chdir('C:\\Users\\marry\\OneDrive\\XLJ\\vehicle1')
...
#print (data)
#从去掉表头的txt文件读取数据
data=pd.read_table('vehicle1.txt',names=['Compactness','Circularity','Distance_circularity','Radius_ratio','Praxis_aspect_ratio','Max_length_aspect_ratio','Scatter_ratio',
'Elongatedness','Praxis_rectangular','Length_rectangular','Major_variance','Minor_variance','Gyration_radius','Major_skewness','Minor_skewness','Minor_kurtosis','Major_kurtosis','Hollows_ratio','class'],sep=', ')
#print(data)
...
data_new1.to_csv('vehicle1_new1.arff',sep=',',header=False,index=False)
data_new2.to_csv('vehicle1_new2.arff',sep=',',header=False,index=False)
data_new3.to_csv('vehicle1_new3.arff',sep=',',header=False,index=False)
